                        ...
                        if(isAdded){
                            ...
                            try{
                                if(it.isNull("result")){
                                    ...
                                    ToastUtil.initializeToast(requireContext(),errorMsg, Toast.LENGTH_LONG).show()
                                }
                                else{
                                    ...
                                    for(state in result.keys()){
                                        ...
                                        for(i in 0 until branches.length()){
                                            ...
                                            if(branch != null){
                                                ...
                                                ToastUtil.initializeToast(requireContext(),"Unable to retrieve complete data from server.",
                                                    Toast.LENGTH_LONG).show()
                                            }
                                        }
                                    }
